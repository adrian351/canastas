...
Route::get('getfecha/{fecha}','Venta\PedidoActivo\PedidoActivoController@total')->middleware('permission:venta.pedidoActivo.edit|venta.pedidoActivo.armado.edit|venta.pedidoActivo.pago.create|venta.pedidoActivo.pago.edit');