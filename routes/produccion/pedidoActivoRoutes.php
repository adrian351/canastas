...
Route::group(['prefix' => 'pedido-activo'], function() {
  ...
  Route::group(['prefix' => 'armado'], function() {
    ...
    // asignar rack a todos los armados del pedido
    // Route::match(['PUT', 'PATCH'],'terminar-armados/{id_armado}', 'Produccion\PedidoActivo\ArmadoPedidoActivo\ArmadoPedidoActivoController@terminarArmados')->name('produccion.pedidoActivo.armado.terminarArmados')->middleware('permission:produccion.pedidoActivo.armado.edit');
