...
<body style="font-family: Segoe UI;">
  <table class="table table-sm table-bordered" style="font-size:12px;">
    <tr>
      ...
      <td>
        ...
        <dt style="font-size: 1.1em; text-align:center">Si tu cotización no cuenta con las características que solicitaste o no han atendido tu requerimiento adecuadamente puedes mandar un correo a (cespeciales@canastasyarcones.mx) y te ayudaremos de manera inmediata.</dt>
  </table><br/>
  ...
  @else 
    ...
    <table class="table table-hover table-striped table-sm table-bordered" style="font-size:12px;">
      ...
      <tbody> 
        {{-- ¿es de stock? solo lo puede ver rosita y jhon  --}}
        {{--  <tr></tr>  --}}
          ...
          <tr style="font-size:17px;">
            ...
            <td>
              ...
              @if($cotizacion->con_com == 'on')
                <a href="https://www.paypal.me/canastasyarcones/{{ Sistema::dosDecimales($cotizacion->tot) }}" target="_blank">Para pago con tarjeta clic aquí,   incluida del 5% ${{ Sistema::dosDecimales($cotizacion->tot) }}</a>
              @else
              {{-- link original : https://www.paypal.me/canastasyarcones/  --}}
              {{-- link nuevo: https://www.paypal.com/paypalme/canastasgfj/ --}}
                <a href="https://www.paypal.com/paypalme/canastasgfj/{{ Sistema::dosDecimales($cotizacion->tot*1.05) }}" target="_blank">Para pago con tarjeta clic aquí, comisión incluida del 5% ${{ Sistema::dosDecimales($cotizacion->tot*1.05) }}</a>
              @endif
            </td>
          </tr>
        @endif
