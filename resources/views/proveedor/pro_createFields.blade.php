<div class="row">
  <div class="form-group col-sm btn-sm">
    ...
    <div class="input-group">
      <div class="input-group-prepend">
        ...
        {!! Form::text('razon_social', null, ['class' => 'form-control' . ($errors->has('razon_social') ? ' is-invalid' : ''), 'maxlength' => 60, 'placeholder' => __('Razón social')]) !!}
    </div>
  ...
  <div class="form-group col-sm btn-sm">
    ...
    <div class="input-group">
      ...
      {!! Form::text('nombre_comercial', null, ['class' => 'form-control' . ($errors->has('nombre_comercial') ? ' is-invalid' : ''), 'maxlength' => 100, 'placeholder' => __('Nombre comercial')]) !!}
    </div>
...
<div class="row">
  <div class="form-group col-sm btn-sm">
    ...
    <div class="input-group">
      ...
      {!! Form::select('fabricante_distribuidor', config('opcionesSelect.select_fabricante_distribuidor_index'), null, ['class' => 'form-control select2' . ($errors->has('fabricante_distribuidor') ? ' is-invalid' : ''), 'placeholder' => __('')]) !!}
    </div>
  ...
  <div class="form-group col-sm btn-sm">
    ...
    <div class="input-group">
      ...
      {!! Form::text('rfc', null, ['class' => 'form-control' . ($errors->has('rfc') ? ' is-invalid' : ''), 'maxlength' => 40, 'placeholder' => __('RFC')]) !!}
    </div>
...
<div class="row">
  <div class="form-group col-sm btn-sm">
    ...
    <div class="input-group">
      ...
      {!! Form::text('nombre_del_representante_legal', null, ['class' => 'form-control' . ($errors->has('nombre_del_representante_legal') ? ' is-invalid' : ''), 'maxlength' => 80, 'placeholder' => __('Nombre del representante legal')]) !!}
    </div>
  ...
  <div class="form-group col-sm btn-sm">
    ...
    <div class="input-group">
      ...
      {!! Form::text('pagina_web', null, ['class' => 'form-control' . ($errors->has('pagina_web') ? ' is-invalid' : ''), 'maxlength' => 100, 'placeholder' => __('Página web')]) !!}
    </div>
...
<div class="row">
  <div class="form-group col-sm btn-sm">
    ...
    <div class="input-group">
      ...
      <div>
        {!! Form::number('lada_telefono_fijo', null, ['class' => 'form-control disabled' . ($errors->has('lada_telefono_fijo') ? ' is-invalid' : ''), 'min' => 1, 'max' => 9999, 'placeholder' => __('Lada '), 'readonly'=>'readonly']) !!}
      </div>
  ...
  <div class="form-group col-sm btn-sm">
    <label for="telefono_movil">{{ __('Número de teléfono móvil a 10 dijitos') }}</label>
    <div class="input-group">
      <div class="input-group-prepend">
        <span class="input-group-text"><i class="fas fa-mobile-alt"></i></span>
      </div>
        <div>
          {!! Form::number('lada_telefono_movil', null, ['class' => 'form-control disabled' . ($errors->has('lada_telefono_movil') ? ' is-invalid' : ''), 'min' => 1, 'max' => 9999, 'placeholder' => __('Lada '), 'readonly' =>'readonly']) !!}
        </div>
...
<div class="row">
  <div class="form-group col-sm btn-sm col-6">
    <label for="cantidad_o_monto_minimo_de_compra">{{ __('Cantidad o monto mínimo de compra') }}</label>
    <div class="input-group">
      <div class="input-group-prepend">
        <span class="input-group-text"><i class="fas fa-text-width"></i></span>
      </div>
      {!! Form::select('opcion', config('opcionesSelect.select_opcion_prov'), null, ['class' => 'form-control' . ($errors->has('opcion') ? ' is-invalid' : ''), 'placeholder' => __('Seleccione. . .')]) !!}
  ...
  <div class="row">
    ...
    <div class="form-group col-sm btn-sm">
      ...
      <div class="input-group">
        ...
        {!! Form::text('no_ext', null, ['class' => 'form-control' . ($errors->has('no_ext') ? ' is-invalid' : ''), 'maxlength' => 8, 'placeholder' => __('No. Ext.')]) !!}
      </div>
    ...
    <div class="form-group col-sm btn-sm">
      ...
      <div class="input-group">
        ...
        {!! Form::text('no_int', null, ['class' => 'form-control' . ($errors->has('no_int') ? ' is-invalid' : ''), 'maxlength' => 30, 'placeholder' => __('No. Int.')]) !!}
      </div>
  ...
  <div class="row">
    <div class="form-group col-sm btn-sm">
      ...
      <div class="input-group">
        ...
        {!! Form::textarea('referencias', null, ['class' => 'form-control' . ($errors->has('referencias') ? ' is-invalid' : ''), 'maxlength' => 30000, 'placeholder' => __('Referencias'), 'rows' => 4, 'cols' => 4]) !!}
      </div>
