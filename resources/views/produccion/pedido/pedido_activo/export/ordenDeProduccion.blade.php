  ...
  <table class="table table-sm table-bordered" style="font-size:12px;margin-right:1rem;">
    ...
    <tr style="text-align:center">
      <td colspan="2">
       ...
       {{-- verificar si el tipo de tarjeta es "Personalizada" --}}
            ...
            <td>
              @foreach($armado->direcciones as $direccion)
                ...
                @if ($direccion->tip_tarj_felic == 'Personalizada')
                    <div>
                      {{--  mostrar el mensaje de dedicatoria en el pdf ( modulo:produccion -> "orden-de-produccion")  --}}
                      {{--  falta poner indicatovo de imagen  --}}
