...
class CotizacionController extends Controller {
  ...
  protected $marcasControlller;
  public function __construct(ServiceCrypt $serviceCrypt, CotizacionRepositories $cotizacionRepositories, AprobarCotizacionRepositories $aprobarCotizacionRepositories, UsuarioRepositories $usuarioRepositories, ArmadoRepositories $armadoRepositories, MarcaController $marcaController) {
    ...
    $this->marcasControlller      = $marcaController;
  }
  ...
  public function edit($id_cotizacion) {
    ...
    // pasamos las marcas
    $marcas_list = $this->marcasControlller->Only_Marcas();
