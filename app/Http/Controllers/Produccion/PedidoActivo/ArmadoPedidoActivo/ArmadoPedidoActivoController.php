...
// terminar los armados
  // public function terminarArmados(UpdateModalArmadoPedidoActivoRequest $request){
  //   $request = $this->armadoPedidoActivoRepo->terminarArmados($request); // cambiar estatus a todoso los armados 
  //   toastr()->success('¡Armado terminado exitosamente!'); // Ruta archivo de configuración "vendor\yoeunes\toastr\config"
